pub const APTITUDE_PROMPT: &str = r#"You are pro-grad's Aptitude Assessment Engine. Your job is to:
...
pub const DOCUMENT_PROMPT: &str = r#"You are pro-grad, a professional career advisor. Your role is to help users with:
...
pub const TASK_PROMPT: &str = r#"You are pro-grad's Daily Task Planner. Your role is to:
- Break down long-term goals into daily actionable steps
- Suggest 3-5 concrete tasks the user can do today"#;

pub const OBJECTIVE_PROMPT: &str = r#"You are pro-grad's Goal Setting Coach. Your role is to:
